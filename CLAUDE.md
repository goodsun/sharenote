# 松蔭（showIN） - Claude Development Configuration
...
cdk deploy showin-dev # Deploy to dev
cdk destroy showin-dev # Clean up
```
...
- **Design process**: ideanotes/services/showin/
