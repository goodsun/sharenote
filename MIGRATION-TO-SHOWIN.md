...
# - Description: 共有手帳（shareNOTE） - 声でつなぐ、家族の知恵
# - Private/Public: お好みで
...
git init
git add .
git commit -m "Initial commit: 共有手帳（shareNOTE） - Forked from showin"
...
- [ ] 開発環境へのデプロイが成功する
- [ ] Alexa スキルのエンドポイントを新しい Lambda ARN に更新
- [ ] フロントエンドが正常に動作する
- [ ] 家族機能が正常に動作する
...
これで完全に新しい「共有手帳（shareNOTE）」プロジェクトとしてスタートできます！
